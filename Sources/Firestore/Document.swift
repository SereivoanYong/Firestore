...
@dynamicMemberLookup public protocol DocumentType: Decodable {
...
extension DocumentType {
  ...
  @inlinable public subscript<T>(dynamicMember keyPath: KeyPath<Fields, T>) -> T.Value where T: ValueType {
...
extension FieldsOnlyDocumentType {
  ...
  @inlinable public subscript<T>(dynamicMember keyPath: WritableKeyPath<Fields, T>) -> T.Value where T: ValueType {
